    ...
    private function addElement(AppendStream $stream, array $element) : void
    {
        ...
        if (\is_scalar($contents) && !\is_string($contents)) {
            ...
            if (\is_float($contents) && !\is_finite($contents)) {
                \Mihdan\IndexNow\Dependencies\trigger_deprecation('guzzlehttp/psr7', '2.12', 'Passing a non-finite float as multipart contents is deprecated; guzzlehttp/psr7 3.0 rejects non-finite floats.');
