...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private static function triggerUnsupportedCurlOptionDeprecations(array $options) : void
    {
        ...
        foreach ($options['curl'] as $option => $_) {
            ...
            \Mihdan\IndexNow\Dependencies\trigger_deprecation('guzzlehttp/guzzle', '7.12', \sprintf('Passing %s in the "curl" request option is deprecated; guzzlehttp/guzzle 8.0 will reject raw cURL options outside the built-in cURL handlers\' allow-list.', self::formatCurlOption($option)));
        }
    }
    ...
    public function release(EasyHandle $easy) : void
    {
        ...
        if (\defined('Mihdan\\IndexNow\\Dependencies\\CURLOPT_PREREQFUNCTION')) {
